...
| **Scope Fidelity** | Align scope, objectives, and interfaces with the strategy. Add missing in-scope items from the strategy. Remove entries that test things the strategy doesn't cover. | 1.2, 1.3, 4 |
